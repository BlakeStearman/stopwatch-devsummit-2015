...
function (
  ...
  return declare(null, {
    ...
    declaredClass: "widgets._StylizedStopwatchMixin",
    ...
    _drawClock: function () {
      ...
      // draw minutes
      this._drawArc(w, h, middleRadius, topAngle, minEndAngle, "#ffaf4d", lineWidth);

      // draw hours
      this._drawArc(w, h, innerRadius, topAngle, hourEndAngle, "#ffd199", lineWidth);
    },
